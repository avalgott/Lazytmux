...
type View struct {
	...
	// CaptureAllKeys allows the view's Editor to receive keystrokes even when
	// the view itself is not editable. This is useful for proxy views that need
	// every keypress without letting TextArea drive the cursor position.
	CaptureAllKeys bool
